...
- Automated unit and component suite: 63 tests across 18 files, passing.
...
| Hosted profile or consent sync returns `offline: true` | Expected in v0.12.0: career records still use browser storage while the authenticated account identity is persisted separately in D1. |
